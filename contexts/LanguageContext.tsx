...
const defaultTranslations: Translations = {
  en: {
    ...
    'driver.driversLicense': 'Driver\'s License',
  ...
  ar: {
    ...
    'driver.applicationDetails': 'تفاصيل تقديم السائق',
    ...
    'driver.year': 'السنة',
    'driver.color': 'اللون',
    'driver.licensePlate': 'رقم الهوية',
    'driver.licenseInfo': 'معلومات رخصة القيادة',
    'driver.licenseNumber': 'رقم الرخصة',
    'driver.expiryDate': 'تاريخ انتهاء الصلاحية',
    'driver.documents': 'المستندات',
    'driver.driversLicense': 'رخصة القيادة',
    'driver.vehicleRegistration': 'تسجيل المركبة',
    'driver.insurance': 'التأمين',
    'driver.backgroundCheck': 'فحص الخلفية',
